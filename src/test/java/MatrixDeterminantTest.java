    ...
    void determinant2x2_example() {
        try {
            ...
            assertEquals(-2, result,
                    "Incorrect determinant for 2×2 matrix. " +
            ...
            fail("An exception occurred while testing the 2×2 case: " + ex + ". " +
    ...
    void determinant3x3_example() {
        try {
            ...
            assertEquals(-11, result,
                    "Incorrect determinant for 3×3 matrix. " +
                            "For a 3×3 matrix [[a,b,c],[p,q,r],[x,y,z]], use the formula " +
                            "a*q*z + b*r*x + c*p*y - a*r*y - b*p*z - c*q*x. " +
                            "Given [[2,1,3],[0,1,4],[5,2,0]] the determinant should be -11, " +
                            "but your method returned " + result + ".");
        } catch (Exception ex) {
            fail("An exception occurred while testing the 3×3 case: " + ex + ". " +
                    "Ensure your determinant() implementation follows the provided 3×3 formula and " +
    ...
    void determinant4x4_returnsZero() {
        try {
            ...
            assertEquals(0, result,
                    "Incorrect determinant for a 4×4 matrix. determinant() should return 0 " +
                            "for square matrices larger than 3×3, as computing the determinant is unsupported " +
                            "in this assignment. Your method returned " + result + ".");
        } catch (Exception ex) {
            fail("An exception occurred while testing the 4×4 case: " + ex + ". " +
        ...
        try {
            ...
            assertEquals(-1, result,
                    "Incorrect determinant for a non‑square matrix. determinant() should return -1 " +
                            "to indicate that a matrix is not square. For a 2×3 matrix the determinant should be -1, " +
                            "but your method returned " + result + ".");
        } catch (Exception ex) {
